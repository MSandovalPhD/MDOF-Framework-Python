"""
LISU 2022. This program activates a gamepad from the input controllers detected.
"""
...
def testLisu():
    ...
    _GAMEPAD = GetFromListGamepads(CONTROLLERS_DETECTED)
    LisuGamepadStart(_GAMEPAD)
...
if __name__ == '__main__':
    ...
    qprompt.echo('LISU automatically configures and activates a gamepad from the input controllers detected to the PC.')
    ...
    with open('Logs/Profiler_LisuGamepad_'+ timestr + '.txt', 'w+') as f:
        f.write(s.getvalue())
